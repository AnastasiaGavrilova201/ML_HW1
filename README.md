...
Наилучший прогноз по метрикам R^2 и MSE дает Ridge регрессия с обработкой признаков, которая показала примерно R^2 = 0,65 и MSE = 203802677420. Также эта модель показала наибольшую долю прогнозов, отклоняющихся от фактических значений не более, чем на 10%.
